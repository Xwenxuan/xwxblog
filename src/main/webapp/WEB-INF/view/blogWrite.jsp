...
<form action="${pageContext.request.getContextPath()}/a/blogWrite/submit">
    <div class="">
        ...
        <%--</select>--%>
        <input type="text" class="am-input-lg" style="width:500px" name="title" required>
    </div>
<div id="layout">
    <header>
    ...
    <div class="">
        文章标签</br>
        <input type="text" class="am-input-lg" style="width:500px" name="tag" required>
    </div>
    <div class="">
        分类</br>
        <input type="text" class="am-input-lg" style="width:500px" name="category" required>
    </div>
    <div class="">
